...
torch.save(ensemble_info, '/Users/ca5/Desktop/qnn_fnl/advanced_hybrid_ensemble.pt')
logger.info("Ensemble model saved to '/Users/ca5/Desktop/qnn_fnl/advanced_hybrid_ensemble.pt'")
